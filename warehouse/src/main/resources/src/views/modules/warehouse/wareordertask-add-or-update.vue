<template>
  <el-dialog
    ...
    <el-form-item label="ž¶¿î·œÊœ¡Ÿ 1:ÔÚÏßž¶¿î 2:»õµœž¶¿î¡¿" prop="paymentWay">
      <el-input v-model="dataForm.paymentWay" placeholder="ž¶¿î·œÊœ¡Ÿ 1:ÔÚÏßž¶¿î 2:»õµœž¶¿î¡¿"></el-input>
    </el-form-item>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          paymentWay: [
            { required: true, message: 'ž¶¿î·œÊœ¡Ÿ 1:ÔÚÏßž¶¿î 2:»õµœž¶¿î¡¿不能为空', trigger: 'blur' }
          ],
          taskStatus: [
            { required: true, message: '不能为空', trigger: 'blur' }
          ],
